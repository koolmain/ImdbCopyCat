...
import com.koolmain.imdb.dto.DegreePathItem;
import com.koolmain.imdb.dto.NameDTO;
...
import com.koolmain.imdb.repository.TitleSummaryRepository;
...
public class DegreeServiceImplIterative implements DegreeService {
    ...
    private DegreeDto getDetailedPath(int degree, List<String> names, List<String> titles){
       ...
       // dto.setBaconDegree(degree);
        ...
        dto.setPath(paths);
        dto.setBaconDegree(paths.size() -1 );
        return dto; 
    }
